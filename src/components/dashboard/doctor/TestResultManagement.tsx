  ...
  const [testResults] = useState([
    ...
    },
    {
      ...
      biomarkers: {
        ...
        c24_0_lpc: { value: 1.24, normal: '0.08 - 2.78', status: 'normal' },
        c26_0_lpc: { value: 0.33, normal: '0.03 - 0.75', status: 'normal' },
        lv_pt_ratio: { value: 2.2, normal: '0.66 - 2.72', status: 'normal' },
        cit_arg_ratio: { value: 7, normal: '0.3 - 19.9', status: 'normal' },
        cit_phe_ratio: { value: 0.28, normal: '0.07 - 0.72', status: 'normal' },
        carnitine_cit_ratio: { value: 5.42, normal: '1.53 - 8.75', status: 'normal' },
        c14_1_c12_1_ratio: { value: 2.47, normal: '0.9 - 5', status: 'normal' },
        leu_phe_ratio: { value: 3.57, normal: '0.63 - 3.74', status: 'normal' },
        met_leu_ratio: { value: 0.1, normal: '0.02 - 0.66', status: 'normal' },
        met_phe_ratio: { value: 0.37, normal: '0.17 - 0.74', status: 'normal' },
        phe_tyr_ratio: { value: 0.42, normal: '0.16 - 1.6', status: 'normal' },
        tyr_leu_ratio: { value: 0.66, normal: '0.13 - 2.64', status: 'normal' },
        tyr_met_ratio: { value: 6.49, normal: '1.86 - 16.06', status: 'normal' },
        val_phe_ratio: { value: 3.38, normal: '0.58 - 3.5', status: 'normal' },
        c3_met_ratio: { value: 0.14, normal: '0.01 - 0.25', status: 'normal' },
        c3_c2_ratio: { value: 0.17, normal: '0.01 - 0.34', status: 'normal' },
        c3_c16_ratio: { value: 1.22, normal: '0.19 - 1.35', status: 'normal' },
        c3dc_c4oh_c8_ratio: { value: 1.5, normal: '0.29 - 5.25', status: 'normal' },
        c0_c16_c18_ratio: { value: 10.22, normal: '1.88 - 12.16', status: 'normal' },
        c4dc_c5oh_c8_ratio: { value: 5.38, normal: '1.38 - 12.6', status: 'normal' },
        c8_c10_ratio: { value: 0.91, normal: '0.4 - 2.3', status: 'normal' },
        c8_c2_ratio: { value: 0.001, normal: '0 - 0.01', status: 'normal' },
        c5dc_c6oh_c8_ratio: { value: 1.83, normal: '0.14 - 9', status: 'normal' },
        c16_c18_1_c2_ratio: { value: 0.16, normal: '0.16 - 0.89', status: 'normal' }
      },
      doctorConclusion: ''
    },
    {
