...
// 1. Interface 'Disease' đã được cập nhật với trường `classification`
interface Disease {
  id: number;
  code: string;
  name: string;
  classification: string; // Đã thêm
  description: string;
  synonyms: string[];
  diagnosis: string;
  treatment: string;
...
export const DiseaseView = () => {
  ...
  // 2. Dữ liệu 'diseases' đã được bổ sung trường `classification`
  const [diseases] = useState<Disease[]>([
    {
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Khởi phát đột ngột khi nhịn ăn, nhiễm trùng hoặc stress chuyển hóa', 'Hạ đường huyết nghiêm trọng nhưng không có thể ceton (hypoketotic hypoglycemia)', 'Nôn mửa, lừ đừ, giảm trương lực cơ, co giật, hôn mê', 'Nhiễm toan chuyển hóa, tăng amoniac, tăng lactate'], lateStage: ['Trẻ có thể chậm phát triển, có nguy cơ tổn thương thần kinh', 'Biểu hiện thần kinh mạn tính như co giật, giảm trương lực cơ, loạn trương lực'], general: ['Triệu chứng thường xuất hiện trong 1 năm đầu đời và các đợt cấp có thể tái phát nếu không được phòng ngừa hiệu quả.'] },
        causes: ['Bệnh là kết quả của đột biến trong gen HMGCL, nằm trên nhiễm sắc thể số 1. Gen này mã hóa enzym HMG-CoA lyase – một thành phần thiết yếu trong cả hai con đường: phân giải leucine và tạo ceton.', 'Khi enzym thiếu hụt: Cơ thể không thể sản xuất đủ thể ceton – nguồn năng lượng quan trọng trong khi nhịn ăn', 'Các chất trung gian độc hại của quá trình phân giải leucine bị tích tụ, ảnh hưởng đến hệ thần kinh và chuyển hóa toàn thân', 'Bệnh di truyền theo kiểu lặn trên nhiễm sắc thể thường. Trẻ mắc bệnh khi nhận hai bản sao gen đột biến từ cha và mẹ.'],
        ...
        similarDiseases: ['Glutaric acidemia type I: cũng gây hạ đường huyết và tổn thương não', 'Medium-chain acyl-CoA dehydrogenase deficiency (MCAD): biểu hiện hạ đường huyết không sinh ceton', 'Methylmalonic acidemia, propionic acidemia, và các rối loạn acid hữu cơ khác có thể có triệu chứng giống nhau như nôn, co giật, nhiễm toan'],
        diagnosticMethods: ['Xét nghiệm acid hữu cơ nước tiểu: Tăng acid 3-hydroxy-3-methylglutaric, acid 3-methylglutaric, acid 3-methylglutaconic', 'Khối phổ tandem (MS/MS): Tăng C6OH-carnitine trong máu', 'Định lượng enzym trong bạch cầu hoặc nguyên bào sợi da', 'Xét nghiệm gen: Phân tích gen HMGCL để xác định đột biến'],
        treatmentDetails: { prevention: ['Tránh nhịn đói: ăn thường xuyên, cả ngày và đêm', 'Tăng năng lượng qua glucose khi bệnh', 'Tránh nhiễm trùng và các yếu tố gây stress chuyển hóa'], diet: ['Hạn chế leucine trong chế độ ăn (protein vừa phải)', 'Bổ sung thực phẩm y tế chuyên biệt ít leucine (theo chỉ định chuyên gia dinh dưỡng)', 'Bổ sung glucose hoặc maltodextrin để duy trì năng lượng'], acuteTreatment: ['Truyền glucose, có thể phối hợp insulin', 'Theo dõi và điều chỉnh điện giải, acid-base', 'Kiểm soát hạ đường huyết, tăng amoniac'], monitoring: ['Đánh giá sự phát triển thể chất, tâm thần vận động', 'Xét nghiệm chức năng gan, điện giải, lactate, amoniac'] },
        ...
        references: ['National Organization for Rare Disorders. 3-Hydroxy-3-Methylglutaric Aciduria', 'Grünert SC, Sass JO, Schwab KO, et al. 3-Hydroxy-3-methylglutaryl-CoA lyase deficiency – clinical presentation and outcome in 37 patients. Orphanet J Rare Dis. 2010;5:25. https://pubmed.ncbi.nlm.nih.gov/20701773', 'Gibson KM, et al. HMG CoA lyase deficiency: Clinical spectrum and molecular analysis. Mol Genet Metab. 2000;70(1):58–65.', 'Zschocke J, Hoffmann GF. Vademecum Metabolicum. 3rd Ed. Schattauer Verlag, 2011.']
      }
    },
    {
      id: 2,
    ...
    },
    {
      ...
      overview: {
        ...
        similarDiseases: ['Các rối loạn chu trình ure khác: OTC deficiency, CPS1 deficiency, Argininemia, ASA lyase deficiency', 'Rối loạn acid hữu cơ (organic acidemias): cũng có thể gây tăng ammoniac, nhiễm toan', 'Nhiễm trùng huyết sơ sinh, xuất huyết não, hạ đường huyết: có thể có biểu hiện lâm sàng tương tự'],
        diagnosticMethods: ['Sàng lọc sơ sinh: ', 'Được phát hiện thông qua chương trình MS/MS – nồng độ citrulline tăng cao trong mẫu máu gót chân', 'Xét nghiệm chẩn đoán: ', 'Xét nghiệm ammoniac máu: tăng rất cao trong thể sơ sinh', 'Acid amin huyết tương: tăng citrulline', 'Xét nghiệm enzym: đo hoạt tính argininosuccinate synthetase trong nguyên bào sợi da', 'Xét nghiệm gen: xác định đột biến trong gen ASS1', 'Chẩn đoán trước sinh: ', 'Phân tích gen thai nhi nếu đã biết đột biến trong gia đình', 'Đo hoạt tính enzym hoặc nồng độ chất chuyển hóa trong dịch ối'],
        treatmentDetails: { acuteTreatment: ['Nhập viện khẩn cấp', 'Truyền glucose để giảm dị hóa', 'Sử dụng thuốc thải amoniac như sodium benzoate, sodium phenylbutyrate', 'Truyền arginine để hỗ trợ chu trình ure', 'Lọc máu trong các trường hợp tăng ammoniac nặng (thường > 500–1000 µmol/L)'], diet: ['Chế độ ăn hạn chế protein (tùy theo độ tuổi và mức độ nặng)', 'Sử dụng thực phẩm y tế chuyên biệt (không chứa citrulline)', 'Bổ sung arginine', 'Thuốc hỗ trợ thải amoniac'], monitoring: ['Xét nghiệm ammoniac, acid amin máu', 'Đánh giá phát triển thần kinh, vận động', 'Đánh giá chế độ dinh dưỡng'] },
    ...
    },
    {
      ...
      overview: {
        ...
        similarDiseases: ['Canavan disease', 'Leigh syndrome', 'Metachromatic leukodystrophy', 'Isovaleric acidemia', 'Methylmalonic acidemia', 'Các bệnh thần kinh tiến triển hoặc loạn trương lực cơ khác'],
        diagnosticMethods: ['Sàng lọc sơ sinh: Thông qua xét nghiệm tandem mass spectrometry (MS/MS), phát hiện mức glutarylcarnitine (C5DC) tăng cao.', 'Xét nghiệm acid hữu cơ trong nước tiểu: Tăng acid glutaric và 3-hydroxyglutaric.', 'Xét nghiệm enzym: Đo hoạt tính glutaryl-CoA dehydrogenase trong bạch cầu hoặc nguyên bào sợi da.', 'Xét nghiệm gen: Phân tích gen GCDH để xác định đột biến.'],
        treatmentDetails: { prevention: ['Mục tiêu điều trị là ngăn ngừa hoặc làm giảm nguy cơ tổn thương não.'], diet: ['Hạn chế lysine và tryptophan', 'Bổ sung L-carnitine để tăng thải độc', 'Sử dụng công thức dinh dưỡng chuyên biệt không chứa lysine'], acuteTreatment: ['Khi có nguy cơ stress chuyển hóa (nhiễm trùng, phẫu thuật...):', 'Tạm ngừng nạp protein', 'Tăng cung cấp năng lượng qua glucose', 'Nhập viện nếu cần truyền dịch, theo dõi thần kinh'], monitoring: ['Định kỳ đánh giá phát triển thần kinh và thể chất', 'MRI sọ não có thể cho thấy tổn thương nhân nền', 'Vật lý trị liệu, phục hồi chức năng', 'Hỗ trợ ngôn ngữ, học tập'] },
    ...
    },
    {
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Bú kém, nôn mửa trong những ngày đầu sau sinh', 'Ngủ gà, giảm phản xạ', 'Hạ đường huyết nhẹ', 'Tăng amoniac máu nhẹ', 'Mùi cơ thể bất thường (mùi mèo)'], lateStage: ['Chậm phát triển thể chất và trí tuệ nhẹ', 'Co giật xuất hiện muộn', 'Yếu cơ, giảm trương lực cơ', 'Nhiễm toan chuyển hóa từng đợt'], general: ['Nhiều trường hợp hoàn toàn không có triệu chứng và được phát hiện tình cờ qua sàng lọc sơ sinh. Triệu chứng thường xuất hiện trong các đợt stress chuyển hóa như nhiễm trùng, nhịn ăn kéo dài hoặc tăng nạp protein.'] },
        causes: ['3-MCC deficiency là bệnh di truyền lặn trên nhiễm sắc thể thường do đột biến ở gen MCCC1 hoặc MCCC2. Hai gen này mã hóa các tiểu đơn vị α và β của enzyme 3-methylcrotonyl-CoA carboxylase.', 'Enzyme này cần biotin làm cofactor và tham gia vào bước thứ ba trong quá trình phân hủy leucine. Khi enzyme thiếu hụt, 3-methylcrotonyl-CoA và các chất chuyển hóa liên quan tích tụ, dẫn đến tăng 3-methylcrotonylglycine trong nước tiểu.'],
        ...
        similarDiseases: ['Isovaleric acidemia: cũng ảnh hưởng đến chuyển hóa leucine', '3-Hydroxy-3-methylglutaric aciduria: rối loạn khác trong con đường phân hủy leucine', 'Biotin deficiency: có thể gây triệu chứng tương tự', 'Multiple carboxylase deficiency: thiếu hụt nhiều enzyme carboxylase'],
        diagnosticMethods: ['Sàng lọc sơ sinh: MS/MS phát hiện tăng C5OH-carnitine', 'Xét nghiệm acid hữu cơ nước tiểu: tăng 3-methylcrotonylglycine', 'Xét nghiệm enzyme: đo hoạt tính 3-methylcrotonyl-CoA carboxylase', 'Xét nghiệm gen: phân tích gen MCCC1 và MCCC2'],
        treatmentDetails: { prevention: ['Tránh nhịn ăn kéo dài', 'Tăng cường dinh dưỡng trong thời kỳ bệnh', 'Giám sát chặt chẽ trong các đợt stress chuyển hóa'], diet: ['Hạn chế leucine trong chế độ ăn', 'Bổ sung L-carnitine (50-100 mg/kg/ngày)', 'Bổ sung biotin nếu cần thiết', 'Duy trì cân bằng dinh dưỡng với protein đủ cho phát triển'], acuteTreatment: ['Truyền glucose để ngăn ngừa dị hóa protein', 'Điều chỉnh acid-base nếu có nhiễm toan', 'Ngừng nạp protein trong thời gian ngắn', 'Theo dõi glucose máu và điện giải'], monitoring: ['Theo dõi phát triển thần kinh và thể chất', 'Xét nghiệm acid hữu cơ nước tiểu định kỳ', 'Đánh giá tình trạng dinh dưỡng', 'Kiểm tra nồng độ carnitine máu'] },
        ...
        references: ['Grünert SC, Sass JO, Schwab KO, et al. 3-Methylcrotonyl-CoA carboxylase deficiency: clinical outcomes and biochemical findings. Orphanet J Rare Dis. 2012;7:31.', 'National Organization for Rare Disorders. 3-Methylcrotonyl-CoA Carboxylase Deficiency.', 'Baumgarter MR, Hörster F, Dionisi-Vici C, et al. Proposed guidelines for the diagnosis and management of methylmalonic and propionic acidemia. Orphanet J Rare Dis. 2014;9:130.']
      }
    },
    {
      id: 7,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Bú kém, nôn mửa, chậm tăng cân trong giai đoạn sơ sinh', 'Thiếu máu megaloblastic xuất hiện sớm', 'Chậm phát triển tâm thần vận động', 'Giảm trương lực cơ, yếu cơ', 'Co giật có thể xuất hiện trong các trường hợp nặng'], lateStage: ['Rối loạn thần kinh tiến triển: ataxia, neuropathy ngoại biên', 'Suy giảm trí tuệ, rối loạn hành vi', 'Vấn đề thị giác: thoái hóa võng mạc', 'Tăng nguy cơ huyết khối do tăng homocysteine'], general: ['Biểu hiện có thể xuất hiện từ sơ sinh đến tuổi trưởng thành tùy thuộc vào mức độ thiếu hụt. Các triệu chứng thường cải thiện nhanh chóng với liệu pháp vitamin B12 thích hợp.'] },
        causes: ['Cbl disorders do đột biến ở các gen liên quan đến hấp thu, vận chuyển và chuyển hóa vitamin B12. Các gen chính bao gồm MMACHC (cblC), MMADHC (cblD), MMAA (cblA), và MMAB (cblB).', 'Các rối loạn này ảnh hưởng đến khả năng tạo ra adenosylcobalamin (cần cho methylmalonyl-CoA mutase) và/hoặc methylcobalamin (cần cho methionine synthase), dẫn đến tích tụ acid methylmalonic và homocysteine.'],
        ...
        similarDiseases: ['Methylmalonic acidemia do thiếu hụt mutase: không đáp ứng với vitamin B12', 'Homocystinuria do thiếu hụt cystathionine β-synthase', 'Folate deficiency: có thể gây thiếu máu megaloblastic tương tự', 'Transcobalamin deficiency: rối loạn vận chuyển vitamin B12'],
        diagnosticMethods: ['Sàng lọc sơ sinh: tăng C3-carnitine và methionine thấp', 'Xét nghiệm acid hữu cơ: tăng methylmalonic acid trong nước tiểu', 'Xét nghiệm acid amin: tăng homocysteine, giảm methionine', 'Đo nồng độ vitamin B12 và các dạng hoạt tính của nó', 'Xét nghiệm gen: phân tích các gen MMACHC, MMADHC, MMAA, MMAB'],
        treatmentDetails: { prevention: ['Theo dõi sát sao các chỉ số sinh hóa', 'Tránh các yếu tố gây stress chuyển hóa', 'Tiêm phòng đầy đủ để tránh nhiễm trùng'], diet: ['Bổ sung hydroxocobalamin hoặc cyanocobalamin (1-10mg/ngày)', 'Bổ sung folate và betaine trong một số trường hợp', 'Hạn chế protein nhẹ nếu cần thiết', 'Bổ sung carnitine để hỗ trợ thải acid hữu cơ'], acuteTreatment: ['Liều cao vitamin B12 trong các đợt cấp', 'Điều trị hỗ trợ cho thiếu máu và các biến chứng', 'Truyền máu nếu thiếu máu nặng', 'Theo dõi chức năng thận và tim'], monitoring: ['Theo dõi methylmalonic acid và homocysteine trong máu/nước tiểu', 'Công thức máu định kỳ để đánh giá thiếu máu', 'Đánh giá phát triển thần kinh và nhận thức', 'Kiểm tra chức năng thận và tim mạch'] },
        ...
        references: ['Carrillo-Carrasco N, Chandler RJ, Venditti CP. Combined methylmalonic acidemia and homocystinuria, cblC type. I. Clinical presentations, diagnosis and management. J Inherit Metab Dis. 2012;35(1):91-102.', 'Huemer M, Scholl-Bürgi S, Hadaya K, et al. Three new cases of late-onset cblC defect and review of the literature illustrating when to consider inborn errors of metabolism beyond infancy. Orphanet J Rare Dis. 2014;9:161.', 'National Organization for Rare Disorders. Methylmalonic Acidemia.']
      }
    },
    {
      id: 8,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Biểu hiện trong 24-48 giờ đầu sau sinh', 'Bú kém, nôn mửa kéo dài', 'Ngủ gà, giảm trương lực cơ', 'Nhiễm toan chuyển hóa nghiêm trọng', 'Tăng amoniac máu, co giật', 'Hôn mê và có thể tử vong nếu không điều trị'], lateStage: ['Chậm phát triển thể chất và trí tuệ', 'Các đợt cấp tái phát với nôn mửa, ngủ gà', 'Cardiomyopathy (bệnh cơ tim)', 'Suy giảm miễn dịch, nhiễm trùng tái phát', 'Osteoporosis và các vấn đề xương'], general: ['Triệu chứng thường xuất hiện sớm và nghiêm trọng. Các đợt cấp có thể được kích hoạt bởi nhiễm trùng, stress, nhịn ăn hoặc tăng nạp protein. Mùi cơ thể đặc trưng có thể xuất hiện.'] },
        causes: ['PA là bệnh di truyền lặn trên nhiễm sắc thể thường do đột biến ở gen PCCA hoặc PCCB. Hai gen này mã hóa các tiểu đơn vị α và β của enzyme propionyl-CoA carboxylase.', 'Enzyme này cần biotin làm cofactor và chuyển hóa propionyl-CoA thành methylmalonyl-CoA. Khi enzyme thiếu hụt, propionic acid và các chất chuyển hóa độc hại tích tụ, gây tổn thương nhiều cơ quan.'],
        ...
        similarDiseases: ['Methylmalonic acidemia: có triệu chứng tương tự nhưng khác về sinh hóa', 'Isovaleric acidemia: cũng gây mùi cơ thể bất thường', 'Multiple carboxylase deficiency: thiếu hụt nhiều enzyme carboxylase', 'Urea cycle disorders: có thể gây tăng amoniac tương tự'],
        diagnosticMethods: ['Sàng lọc sơ sinh: MS/MS phát hiện tăng C3-carnitine', 'Xét nghiệm acid hữu cơ: tăng propionic acid, 3-hydroxypropionate', 'Xét nghiệm enzyme: đo hoạt tính propionyl-CoA carboxylase', 'Xét nghiệm gen: phân tích gen PCCA và PCCB', 'Đánh giá chức năng gan, thận và tim'],
        treatmentDetails: { prevention: ['Tránh nhịn ăn kéo dài', 'Điều trị nhiễm trùng sớm và tích cực', 'Tăng cường năng lượng trong thời kỳ stress', 'Vaccine phòng bệnh đầy đủ'], diet: ['Hạn chế protein (0.5-1.5g/kg/ngày)', 'Tránh các acid amin isoleucine, valine, threonine, methionine', 'Bổ sung L-carnitine (100-400mg/kg/ngày)', 'Bổ sung biotin và các vitamin nhóm B'], acuteTreatment: ['Ngừng nạp protein ngay lập tức', 'Truyền glucose để ngăn ngừa dị hóa', 'Điều chỉnh acid-base và điện giải', 'Lọc máu nếu tăng amoniac nghiêm trọng', 'Hỗ trợ hô hấp và tuần hoàn nếu cần'], monitoring: ['Theo dõi acid hữu cơ nước tiểu định kỳ', 'Kiểm tra chức năng gan, thận định kỳ', 'Đánh giá phát triển thần kinh và nhận thức', 'Theo dõi tình trạng dinh dưỡng và tăng trưởng'] },
        ...
        references: ['Baumgartner MR, Hörster F, Dionisi-Vici C, et al. Proposed guidelines for the diagnosis and management of methylmalonic and propionic acidemia. Orphanet J Rare Dis. 2014;9:130.', 'Schwab MA, Sauer SW, Okun JG, et al. Secondary mitochondrial dysfunction in propionic aciduria: a pathogenic role for endogenous mitochondrial toxins. Biochem J. 2006;398(1):107-12.', 'National Organization for Rare Disorders. Propionic Acidemia.']
      }
    },
    {
      id: 9,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Khởi phát thường sau 6 tháng tuổi', 'Nôn mửa kéo dài, từ chối ăn', 'Ngủ gà, giảm hoạt động', 'Thở nhanh, sâu (Kussmaul breathing)', 'Mùi thở ngọt (do ketone)', 'Mất nước, giảm cân nhanh'], lateStage: ['Các đợt ketoacidosis tái phát', 'Phát triển bình thường giữa các đợt cấp', 'Có thể chậm phát triển nhẹ nếu có nhiều đợt cấp', 'Rối loạn học tập nhẹ ở một số trường hợp'], general: ['Bệnh nhân thường hoàn toàn bình thường giữa các đợt cấp. Các đợt ketoacidosis thường được kích hoạt bởi nhịn ăn kéo dài, nhiễm trùng, stress hoặc tăng nạp protein.'] },
        causes: ['β-Ketothiolase deficiency là bệnh di truyền lặn trên nhiễm sắc thể thường do đột biến ở gen ACAT1. Gen này mã hóa enzyme mitochondrial acetoacetyl-CoA thiolase (MAT).', 'Enzyme MAT tham gia vào hai con đường chuyển hóa: phân hủy isoleucine và ketolysis. Khi enzyme thiếu hụt, ketone bodies không được chuyển hóa hiệu quả, dẫn đến tích tụ và ketoacidosis.'],
        ...
        similarDiseases: ['Diabetic ketoacidosis: có triệu chứng ketoacidosis tương tự', 'HMG-CoA lyase deficiency: cũng gây ketoacidosis và hạ đường huyết', 'Fatty acid oxidation disorders: có thể gây ketoacidosis hypoketotic', 'Isovaleric acidemia: cũng ảnh hưởng đến chuyển hóa isoleucine'],
        diagnosticMethods: ['Xét nghiệm acid hữu cơ nước tiểu: tăng 2-methyl-3-hydroxybutyric acid, tiglylglycine', 'Xét nghiệm máu: ketoacidosis, tăng ketone bodies', 'MS/MS: có thể phát hiện bất thường trong sàng lọc mở rộng', 'Xét nghiệm enzyme: đo hoạt tính acetoacetyl-CoA thiolase', 'Xét nghiệm gen: phân tích gen ACAT1'],
        treatmentDetails: { prevention: ['Tránh nhịn ăn kéo dài (>8-12 giờ)', 'Ăn thường xuyên, nhất là trước khi ngủ', 'Tăng cường dinh dưỡng trong thời kỳ bệnh', 'Giáo dục gia đình về dấu hiệu cảnh báo'], diet: ['Chế độ ăn đều đặn, nhiều bữa nhỏ', 'Hạn chế nhẹ isoleucine nếu cần', 'Tăng carbohydrate trong thời kỳ stress', 'Bổ sung glucose/dextrose khi có triệu chứng sớm'], acuteTreatment: ['Truyền glucose IV ngay lập tức', 'Điều chỉnh acid-base bằng bicarbonate nếu cần', 'Bù dịch và điện giải', 'Ngừng nạp protein tạm thời', 'Theo dõi sát glucose và ketone máu'], monitoring: ['Theo dõi phát triển thể chất và nhận thức', 'Xét nghiệm acid hữu cơ định kỳ', 'Đánh giá tuân thủ chế độ ăn', 'Giáo dục gia đình về quản lý cấp cứu'] },
        ...
        references: ['Fukao T, Mitchell G, Sass JO, et al. Ketone body metabolism and its defects. J Inherit Metab Dis. 2014;37(4):541-51.', 'National Organization for Rare Disorders. Beta-Ketothiolase Deficiency.', 'Sass JO. Inborn errors of ketogenesis and ketone body utilization. J Inherit Metab Dis. 2012;35(1):23-8.']
      }
    },
    {
      id: 10,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Bú kém, nôn mửa trong giai đoạn sơ sinh', 'Thiếu máu megaloblastic xuất hiện sớm', 'Chậm tăng cân, suy dinh dưỡng', 'Chậm phát triển tâm thần vận động', 'Giảm trương lực cơ, yếu cơ'], lateStage: ['Rối loạn thần kinh tiến triển: dementia, ataxia', 'Vấn đề thị giác: thoái hóa võng mạc, glaucoma', 'Huyết khối tĩnh mạch và động mạch', 'Suy thận tiến triển', 'Cardiomyopathy, tăng huyết áp phổi'], general: ['Biểu hiện có thể xuất hiện từ sơ sinh đến tuổi trưởng thành. Mức độ nghiêm trọng phụ thuộc vào kiểu gen và mức độ đáp ứng với vitamin B12.'] },
        causes: ['MMA-HC do đột biến ở các gen liên quan đến chuyển hóa vitamin B12, chủ yếu là MMACHC (cblC), MMADHC (cblD), MMAA (cblA), MMAB (cblB).', 'Các đột biến này ảnh hưởng đến tổng hợp adenosylcobalamin và methylcobalamin, dẫn đến thiếu hụt hoạt tính methylmalonyl-CoA mutase và methionine synthase, gây tích tụ cả MMA và homocysteine.'],
        ...
        similarDiseases: ['Isolated methylmalonic acidemia: chỉ có tăng MMA', 'Isolated homocystinuria: chỉ có tăng homocysteine', 'Folate deficiency: có thể gây thiếu máu megaloblastic tương tự', 'Classical homocystinuria (CBS deficiency): chỉ có tăng homocysteine'],
        diagnosticMethods: ['Sàng lọc sơ sinh: MS/MS có thể phát hiện bất thường methionine', 'Xét nghiệm acid hữu cơ: tăng methylmalonic acid', 'Xét nghiệm acid amin: tăng homocysteine, giảm methionine', 'Đo nồng độ vitamin B12 và các metabolite', 'Xét nghiệm gen: phân tích các gen liên quan'],
        treatmentDetails: { prevention: ['Theo dõi sát sao các chỉ số sinh hóa', 'Phòng ngừa huyết khối bằng aspirin liều thấp', 'Vaccine đầy đủ để tránh nhiễm trùng', 'Theo dõi chức năng thận và tim mạch'], diet: ['Bổ sung hydroxocobalamin hoặc cyanocobalamin (liều cao)', 'Bổ sung folate và betaine', 'Hạn chế protein và methionine', 'Bổ sung carnitine để hỗ trợ thải độc'], acuteTreatment: ['Liều cao vitamin B12 trong các đợt cấp', 'Điều trị hỗ trợ cho thiếu máu nặng', 'Quản lý biến chứng huyết khối', 'Theo dõi chức năng thận và tim'], monitoring: ['Theo dõi MMA và homocysteine định kỳ', 'Khám mắt định kỳ để phát hiện thoái hóa võng mạc', 'Đánh giá chức năng thận và tim mạch', 'Theo dõi phát triển thần kinh và nhận thức'] },
        ...
        references: ['Huemer M, Baumgartner MR. The clinical presentation of cobalamin-related disorders: From acquired deficiencies to inborn errors of absorption and intracellular metabolism. J Inherit Metab Dis. 2019;42(4):686-705.', 'Carrillo-Carrasco N, Venditti CP. Combined methylmalonic acidemia and homocystinuria. GeneReviews. University of Washington, Seattle.', 'National Organization for Rare Disorders. Methylmalonic Acidemia with Homocystinuria.']
      }
    },
    {
      id: 11,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Biểu hiện sớm trong giai đoạn sơ sinh với bú kém, nôn mửa', 'Thiếu máu megaloblastic nghiêm trọng', 'Chậm phát triển tâm thần vận động rõ rệt', 'Nhiễm toan chuyển hóa', 'Giảm trương lực cơ và yếu cơ'], lateStage: ['Suy thận tiến triển nhanh, có thể cần lọc máu', 'Thoái hóa võng mạc và các vấn đề thị giác nghiêm trọng', 'Rối loạn thần kinh tiến triển: co giật, dementia', 'Bệnh mạch máu và huyết khối', 'Suy tim và tăng huyết áp phổi'], general: ['CblD thường có biểu hiện nghiêm trọng hơn các kiểu cbl khác và đáp ứng kém với điều trị vitamin B12. Các biến chứng thường xuất hiện sớm và tiến triển nhanh.'] },
        causes: ['CblD do đột biến ở gen MMADHC, mã hóa protein tham gia vào quá trình chuyển hóa vitamin B12 trong tế bào.', 'Protein MMADHC cần thiết cho việc chuyển đổi cobalamin thành các dạng hoạt tính adenosylcobalamin và methylcobalamin, dẫn đến thiếu hụt cả hai con đường chuyển hóa.'],
        ...
        similarDiseases: ['CblC deficiency: có triệu chứng tương tự nhưng thường nhẹ hơn', 'Isolated methylmalonic acidemia', 'Hemolytic uremic syndrome: có thể gây suy thận tương tự'],
        diagnosticMethods: ['Xét nghiệm acid hữu cơ: tăng cao methylmalonic acid', 'Xét nghiệm acid amin: tăng homocysteine, giảm methionine', 'Đo nồng độ vitamin B12 và các metabolite', 'Xét nghiệm gen MMADHC: phát hiện đột biến đặc hiệu', 'Đánh giá chức năng thận và mắt'],
        treatmentDetails: { prevention: ['Theo dõi chặt chẽ chức năng thận', 'Kiểm tra mắt định kỳ', 'Phòng ngừa nhiễm trùng và biến chứng'], diet: ['Bổ sung hydroxocobalamin liều cao', 'Bổ sung folate và betaine', 'Hạn chế protein nghiêm ngặt', 'Bổ sung carnitine và các vitamin'], acuteTreatment: ['Liều rất cao vitamin B12', 'Lọc máu nếu suy thận nặng', 'Điều trị hỗ trợ cho các biến chứng', 'Theo dõi tích cực trong ICU'], monitoring: ['Theo dõi chức năng thận hàng tuần', 'Đánh giá mắt định kỳ', 'Theo dõi các chỉ số sinh hóa', 'Đánh giá phát triển thần kinh'] },
        ...
        references: ['Weisfeld-Adams JD, Morrissey MA, Kirmse BM, et al. Newborn screening and early biochemical follow-up in combined methylmalonic aciduria and homocystinuria, cblC type. Mol Genet Metab. 2010;99(2):116-23.', 'National Organization for Rare Disorders. Methylmalonic Acidemia with Homocystinuria, cblD Type.', 'Huemer M, et al. Guidelines for the diagnosis and management of cblC-type methylmalonic aciduria and homocystinuria. J Inherit Metab Dis. 2017;40(1):21-48.']
      }
    },
    {
      id: 12,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Nhiều trường hợp không có triệu chứng trong giai đoạn sơ sinh', 'Chậm tăng cân, bú kém ở một số trường hợp', 'Co giật có thể xuất hiện sớm', 'Chậm phát triển vận động nhẹ'], lateStage: ['Chậm phát triển trí tuệ nhẹ đến trung bình', 'Cardiomyopathy trong một số trường hợp', 'Rối loạn học tập và hành vi', 'Nhiễm toan chuyển hóa nhẹ'], general: ['Biểu hiện lâm sàng rất đa dạng, từ hoàn toàn bình thường đến có triệu chứng rõ rệt. Mức độ nghiêm trọng không hoàn toàn tương quan với nồng độ malonic acid.'] },
        causes: ['Malonic acidemia do đột biến ở gen MLYCD, mã hóa enzyme malonyl-CoA decarboxylase.', 'Enzyme này tham gia vào điều hòa oxy hóa acid béo và tổng hợp acid béo. Khi thiếu hụt, malonyl-CoA tích tụ và được chuyển hóa thành malonic acid.'],
        ...
        similarDiseases: ['Fatty acid oxidation disorders: có thể có triệu chứng tương tự', 'Methylmalonic acidemia: cũng gây tăng acid hữu cơ', 'Cardiomyopathy do các nguyên nhân khác'],
        diagnosticMethods: ['Xét nghiệm acid hữu cơ nước tiểu: tăng malonic acid', 'MS/MS: có thể phát hiện tăng C3DC-carnitine', 'Xét nghiệm enzyme: đo hoạt tính malonyl-CoA decarboxylase', 'Xét nghiệm gen: phân tích gen MLYCD'],
        treatmentDetails: { prevention: ['Tránh nhịn ăn kéo dài', 'Ăn thường xuyên, đặc biệt trước khi ngủ', 'Theo dõi phát triển nhận thức'], diet: ['Chế độ ăn cân bằng, không cần hạn chế đặc biệt', 'Tăng cường dinh dưỡng trong thời kỳ bệnh', 'Có thể bổ sung carnitine nếu cần'], acuteTreatment: ['Điều trị triệu chứng khi có co giật', 'Hỗ trợ dinh dưỡng trong thời kỳ cấp', 'Theo dõi chức năng tim nếu có cardiomyopathy'], monitoring: ['Đánh giá phát triển thần kinh định kỳ', 'Siêu âm tim để theo dõi chức năng tim', 'Xét nghiệm acid hữu cơ định kỳ', 'Hỗ trợ giáo dục đặc biệt nếu cần'] },
        ...
        references: ['National Organization for Rare Disorders. Malonic Acidemia.', 'Souri M, Aoyama T, Hoganson G, Hashimoto T. Very long-chain acyl-CoA dehydrogenase deficiency: molecular diagnosis by newborn screening. Mol Genet Metab. 2005;85(2):150-6.', 'Jurecki E, Cederbaum S, Kopesky J, et al. Adherence to clinic recommendations among patients with phenylketonuria in the United States. Mol Genet Metab. 2017;120(3):190-197.']
      }
    },
    {
      id: 13,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Hầu hết hoàn toàn không có triệu chứng', 'Phát triển bình thường trong giai đoạn sơ sinh', 'Không có biểu hiện bất thường về thể chất'], lateStage: ['Tiếp tục phát triển bình thường', 'Một số nghiên cứu báo cáo chậm phát triển nhẹ nhưng chưa được xác nhận', 'Không có biến chứng nghiêm trọng'], general: ['IBG được coi là một biến thể bình thường hơn là một bệnh lý. Hầu hết các trường hợp được phát hiện qua sàng lọc sơ sinh và không bao giờ có triệu chứng.'] },
        causes: ['IBG do đột biến ở gen ACAD8, mã hóa enzyme isobutyryl-CoA dehydrogenase.', 'Enzyme này tham gia vào bước đầu của quá trình phân hủy valine. Khi thiếu hụt, isobutyryl-CoA được chuyển hóa thành isobutyrylglycine và thải qua nước tiểu.'],
        ...
        similarDiseases: ['Short-chain acyl-CoA dehydrogenase deficiency: cũng thường lành tính', 'Ethylmalonic encephalopathy: có thể có triệu chứng tương tự nhưng nghiêm trọng hơn', 'Các rối loạn chuyển hóa valine khác'],
        diagnosticMethods: ['Sàng lọc sơ sinh: MS/MS có thể phát hiện tăng C4-carnitine', 'Xét nghiệm acid hữu cơ nước tiểu: tăng isobutyrylglycine', 'Xét nghiệm gen: phân tích gen ACAD8', 'Thường không cần xét nghiệm enzyme'],
        treatmentDetails: { prevention: ['Không cần biện pháp phòng ngừa đặc biệt', 'Theo dõi phát triển thông thường'], diet: ['Không cần hạn chế chế độ ăn', 'Chế độ ăn bình thường phù hợp với tuổi', 'Không cần bổ sung vitamin hay carnitine'], acuteTreatment: ['Không cần điều trị cấp cứu', 'Điều trị triệu chứng nếu có vấn đề khác không liên quan'], monitoring: ['Theo dõi phát triển thông thường như trẻ bình thường', 'Không cần xét nghiệm sinh hóa đặc biệt', 'Tư vấn di truyền cho gia đình'] },
        ...
        references: ['National Organization for Rare Disorders. Isobutyrylglycinuria.', 'Koeberl DD, Young SP, Gregersen NS, et al. Rare disorders of metabolism with elevated butyryl- and isobutyryl-carnitine detected by tandem mass spectrometry newborn screening. Pediatr Res. 2003;54(2):219-23.', 'Ferdinandusse S, Friederich MW, Burlina A, et al. Clinical and biochemical characterization of four patients with mutations in ECHS1. Orphanet J Rare Dis. 2015;10:79.']
      }
    },
    {
      id: 14,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Thường không có triệu chứng rõ rệt trong giai đoạn sơ sinh', 'Có thể chậm phát triển vận động nhẹ', 'Bú và tăng cân bình thường'], lateStage: ['Chậm phát triển trí tuệ nhẹ ở một số trường hợp', 'Rối loạn học tập nhẹ', 'Một số có thể có rối loạn hành vi nhẹ'], general: ['Phổ biểu hiện rộng từ hoàn toàn bình thường đến chậm phát triển nhẹ. Mức độ nghiêm trọng không tương quan với nồng độ acid trong nước tiểu.'] },
        causes: ['2-Methyl-3-hydroxybutyric acidemia do đột biến ở gen HADH2, mã hóa enzyme 2-methyl-3-hydroxybutyryl-CoA dehydrogenase.', 'Enzyme này tham gia vào quá trình phân hủy isoleucine. Khi thiếu hụt, 2-methyl-3-hydroxybutyric acid tích tụ và thải qua nước tiểu.'],
        ...
        similarDiseases: ['Beta-ketothiolase deficiency: cũng ảnh hưởng đến chuyển hóa isoleucine', 'Methylmalonic acidemia: có thể có triệu chứng tương tự', 'Các rối loạn chuyển hóa acid amino khác'],
        diagnosticMethods: ['Xét nghiệm acid hữu cơ nước tiểu: tăng 2-methyl-3-hydroxybutyric acid', 'MS/MS: có thể phát hiện bất thường trong một số trường hợp', 'Xét nghiệm gen: phân tích gen HADH2', 'Đánh giá phát triển thần kinh'],
        treatmentDetails: { prevention: ['Theo dõi phát triển định kỳ', 'Không cần biện pháp phòng ngừa đặc biệt'], diet: ['Chế độ ăn cân bằng bình thường', 'Không cần hạn chế isoleucine nghiêm ngặt', 'Đảm bảo dinh dưỡng đầy đủ cho phát triển'], acuteTreatment: ['Thường không cần điều trị cấp cứu', 'Điều trị hỗ trợ nếu có các vấn đề khác'], monitoring: ['Đánh giá phát triển thần kinh định kỳ', 'Hỗ trợ giáo dục đặc biệt nếu cần', 'Xét nghiệm acid hữu cơ định kỳ'] },
        ...
        references: ['Olsen RK, Olpin SE, Andresen BS, et al. ETFDH mutations as a major cause of riboflavin-responsive multiple acyl-CoA dehydrogenation deficiency. Brain. 2007;130(8):2045-54.', 'National Organization for Rare Disorders. 2-Methyl-3-hydroxybutyric acidemia.', 'Sass JO, Ensenauer R, Röschinger W, et al. 2-Methylbutyryl-CoA dehydrogenase deficiency: functional and molecular studies on a defect in isoleucine catabolism. Mol Genet Metab. 2008;93(1):30-5.']
      }
    },
    {
      id: 15,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Hoàn toàn không có triệu chứng trong giai đoạn sơ sinh', 'Phát triển bình thường', 'Không có bất thường về thể chất'], lateStage: ['Tiếp tục phát triển bình thường', 'Không có biến chứng lâu dài', 'Có thể chậm phát triển rất nhẹ nhưng chưa được khẳng định'], general: ['Được coi là một biến thể sinh hóa lành tính. Hầu hết các trường hợp không bao giờ có triệu chứng và được phát hiện tình cờ.'] },
        causes: ['2-Methylbutyrylglycinuria do đột biến ở gen SBCAD (ACADSB), mã hóa enzyme 2-methylbutyryl-CoA dehydrogenase.', 'Enzyme này tham gia vào quá trình phân hủy isoleucine. Khi thiếu hụt, 2-methylbutyryl-CoA được chuyển hóa thành 2-methylbutyrylglycine.'],
        ...
        similarDiseases: ['Isobutyrylglycinuria: cũng rất lành tính và không triệu chứng', 'Short-chain acyl-CoA dehydrogenase deficiency', 'Các rối loạn chuyển hóa isoleucine khác'],
        diagnosticMethods: ['Xét nghiệm acid hữu cơ nước tiểu: tăng 2-methylbutyrylglycine', 'MS/MS: có thể phát hiện bất thường C5-carnitine', 'Xét nghiệm gen: phân tích gen SBCAD', 'Thường không cần xét nghiệm enzyme'],
        treatmentDetails: { prevention: ['Không cần biện pháp phòng ngừa', 'Theo dõi phát triển thông thường'], diet: ['Chế độ ăn bình thường', 'Không cần hạn chế isoleucine', 'Không cần bổ sung đặc biệt'], acuteTreatment: ['Không cần điều trị cấp cứu', 'Không có các đợt cấp'], monitoring: ['Theo dõi phát triển thông thường', 'Tư vấn di truyền cho gia đình', 'Không cần xét nghiệm đặc biệt'] },
        prognosis: 'Tiên lượng hoàn toàn tốt. Được coi là một biến thể bình thường hơn là một bệnh lý cần điều trị.',
        references: ['National Organization for Rare Disorders. 2-Methylbutyrylglycinuria.', 'Gibson KM, Bennett MJ, Naylor EW, Morton DH. Short-chain acyl-coenzyme A dehydrogenase deficiency. Acta Paediatr Suppl. 1999;88(432):59-61.', 'Sass JO, Ensenauer R, Röschinger W, et al. 2-Methylbutyryl-CoA dehydrogenase deficiency. Mol Genet Metab. 2008;93(1):30-5.']
      }
    },
    {
      id: 16,
      ...
      overview: {
        signsAndSymptoms: { earlyStage: ['Chậm phát triển nhẹ trong giai đoạn nhũ nhi', 'Có thể có chậm nói', 'Giảm trương lực cơ nhẹ', 'Bú và tăng cân có thể chậm'], lateStage: ['Chậm phát triển trí tuệ nhẹ đến trung bình', 'Rối loạn ngôn ngữ và học tập', 'Co giật ở một số trường hợp', 'Nhiễm toan chuyển hóa nhẹ từng đợt'], general: ['3-MGA I thường có biểu hiện nhẹ nhất trong nhóm 3-methylglutaconic acidemia. Các triệu chứng chủ yếu liên quan đến chậm phát triển và rối loạn học tập.'] },
        causes: ['3-MGA I do đột biến ở gen AUH, mã hóa enzyme 3-methylglutaconyl-CoA hydratase.', 'Enzyme này tham gia vào con đường phân hủy leucine. Khi thiếu hụt, 3-methylglutaconic acid và 3-methylglutaric acid tích tụ và thải qua nước tiểu.'],
        ...
        similarDiseases: ['3-Methylglutaconic acidemia type II (Barth syndrome): nghiêm trọng hơn với cardiomyopathy', '3-Methylglutaconic acidemia type III: có rối loạn thần kinh nặng hơn', 'HMG-CoA lyase deficiency: cũng ảnh hưởng đến chuyển hóa leucine'],
        diagnosticMethods: ['Xét nghiệm acid hữu cơ nước tiểu: tăng 3-methylglutaconic acid và 3-methylglutaric acid', 'MS/MS: có thể phát hiện bất thường trong sàng lọc mở rộng', 'Xét nghiệm enzyme: đo hoạt tính 3-methylglutaconyl-CoA hydratase', 'Xét nghiệm gen: phân tích gen AUH'],
        treatmentDetails: { prevention: ['Tránh stress chuyển hóa', 'Theo dõi phát triển nhận thức', 'Giáo dục gia đình về dấu hiệu cảnh báo'], diet: ['Hạn chế leucine trong chế độ ăn', 'Bổ sung L-carnitine', 'Chế độ ăn cân bằng với protein vừa phải', 'Tránh nhịn ăn kéo dài'], acuteTreatment: ['Điều trị nhiễm toan nếu có', 'Hỗ trợ dinh dưỡng trong thời kỳ bệnh', 'Điều trị co giật nếu xuất hiện'], monitoring: ['Đánh giá phát triển thần kinh định kỳ', 'Xét nghiệm acid hữu cơ định kỳ', 'Hỗ trợ giáo dục đặc biệt', 'Theo dõi tình trạng dinh dưỡng'] },
        ...
        references: ['National Organization for Rare Disorders. 3-Methylglutaconic Acidemia.', 'Wortmann SB, Kluijtmans LA, Rodenburg RJ, et al. 3-Methylglutaconic aciduria type I redefined: a syndrome with late-onset leukoencephalopathy. Neurology. 2010;75(12):1079-83.', 'Kelson TL, Secor McVoy JR, Rizzo WB. Human liver fatty aldehyde dehydrogenase: microsomal localization, purification, and biochemical characterization. Biochim Biophys Acta. 1997;1335(1-2):99-110.']
      }
    }
  ]);

  // 3. Logic filter đã được cập nhật để tìm kiếm theo `classification`
      ...
      <Card>
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input
              placeholder="Tìm kiếm theo tên, mã bệnh, hoặc phân loại..."
              value={searchTerm}
      ...
      <Card>
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                {/* 4. Tiêu đề bảng đã được thay đổi */}
            ...
            <TableBody>
              {currentDiseases.map((disease) => (
                <TableRow key={disease.id}>
                  ...
                  {/* 5. Dữ liệu `classification` được hiển thị trong cột thứ ba */}
                  <TableCell>
